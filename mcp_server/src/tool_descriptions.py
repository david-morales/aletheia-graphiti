...
def _key_tools_lines() -> list[str]:
    ...
    return [
        ...
        '',
        '15. build_communities -- DESTRUCTIVE despite the name. It deletes EVERY',
        '    community in the graph -- including those of group_ids you did not ask',
        '    for, which are NOT rebuilt -- and then re-clusters the requested ones.',
        '    Run it after a significant ingestion, on a connector whose graph you own,',
        '    then search with search_mode="communities".',
        '',
