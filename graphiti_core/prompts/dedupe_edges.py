...
1. DUPLICATE DETECTION:
   ...
   - Treat the following as equivalent when judging duplicates: active vs passive voice (e.g. "A owns B" and "B is owned by A" express the same relationship); numeric format variations for the same underlying value (e.g. "$6 billion", "$6,000,000,000" and "6B USD"); and known aliases or alternate names for the same entity (e.g. "al-Shabaab" and "Harakat al-Shabaab al-Mujahideen").
